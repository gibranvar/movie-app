...
import './footer.styles.css'
 const Footer = () => {
  return (
    <footer claasName="ftr">
        <div className='ftr-content'>
        <div className="social-media">
            <div>FOLLOW ME.
                <a class="social" href="http://www.instagram.com/gibran.var">
                ...
                <a class="social" href="https://github.com/gibranvar">
            ...
            <div>
                <span>DESIGNED AND DEVELOPED BY GIBRAN VARGAS ©2022</span>
            </div>
        </div>
        <div className="terms">
